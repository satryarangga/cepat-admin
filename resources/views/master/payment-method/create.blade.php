	            ...
	            <form class="form-horizontal" action="{{route("$page.store")}}" method="post" enctype="multipart/form-data">
	              ...
	              <div class="box-body">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" class="form-control" name="name" value="{{old('name')}}" id="name" placeholder="Payment Name">
	                  </div>
	                </div>
	                ...
	                <div class="form-group">
			            ...
			            <div class="col-sm-10">
				            <label class="radio-inline">
				            	<input @if(old('confirm_type') == 1) checked="checked" @endif type="radio" value="1" name="confirm_type">Manual
				            </label>
				            <label class="radio-inline">
				            	<input @if(old('confirm_type') == 2) checked="checked" @endif type="radio" value="2" name="confirm_type">Automatic
				            </label>
			               </div>
			         </div>
			         ...
			         <div class="form-group">
			            ...
			            <div class="col-sm-10">
				            <label class="radio-inline">
				            	<input @if(old('use_paycode') == 0) checked="checked" @endif type="radio" value="0" name="use_paycode">No
				            </label>
				            <label class="radio-inline">
