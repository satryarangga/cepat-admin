	              ...
	              <div class="box-body">
	                ...
	                <div class="form-group">
			         ...
			         <div class="form-group">
			            ...
			            <div class="col-sm-10">
				            <label class="radio-inline">
				            	<input @if($row->is_virtual_account == 0) checked="checked" @endif type="radio" value="0" name="is_virtual_account">No
				            </label>
				            <label class="radio-inline">
				            	<input @if($row->is_virtual_account == 1) checked="checked" @endif type="radio" value="1" name="is_virtual_account">Yes
				            </label>
			               </div>
			         </div>
			         ...
			         <div class="form-group">
	                  ...
	                  <div class="col-sm-10">
	                    <input type="text" class="form-control" name="va_bank_code" value="{{$row->va_bank_code}}" id="name" placeholder="Fill only for virtual account. Example : BNI, MANDIRI, BRI, BCA">
	                  </div>
	                </div>
